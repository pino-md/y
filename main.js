...
if (time == res0) {
  conn.sendMessage('628891753051@s.whatsapp.net', {text: `Bangun Pino Sudah Mulai Subuh!`})
  conn.updateProfileStatus(capt + '  Times taipei')
} else if (time == res1) {
  conn.sendMessage('628891753051@s.whatsapp.net', {text: `Jngan lupa solat Dzuhur Pino!`})
} else if (time == res2) {
  conn.sendMessage('628891753051@s.whatsapp.net', {text: `Waktunya Ashar yuk solat!`})
} else if (time == res3) {
  conn.sendMessage('628891753051@s.whatsapp.net', {text: `Udah Maghrib Pino Jangan Ngegem Mulu!`})
} else if (time == res4) {
  conn.sendMessage('628891753051@s.whatsapp.net', {text: `Oyy jngan maen mulu Isyaan dlu sana!`})
} else if (time == '08:00:00') {
  conn.sendMessage('628891753051@s.whatsapp.net', {text: capt})
}
...
if (time === '06:00:00') {
conn.sendMessage("628891753051@s.whatsapp.net", {text: times})
} else {
...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`628891753051@s.whatsapp.net`, {text: 'Successfully connected by Zahra' }) //made by Muhammad Ridwan Reynaldy 
}
